...
- **HeyOrca:** https://www.heyorca.com/blog/facebook-social-news
- **Social Media Today:** https://www.socialmediatoday.com/topic/facebook/
- **SocialBee (Hub):** https://socialbee.com/blog/social-media/facebook/
- **SocialBee (Algorithmus):** https://socialbee.com/blog/facebook-algorithm/
- **SocialBee (Posting-Zeiten):** https://socialbee.com/blog/best-time-to-post-on-facebook/
...
| Datei | Inhalt |
|---|---|
| `01-algorithmus.md` | Feed-Logik, Ranking-Signale, Reels-Algorithmus, Empfehlungen |
| `02-content-formate.md` | Alle Formate inkl. Reels, Stories, Live, Articles, Forum App |
| `03-posting-zeiten-frequenz.md` | Optimale Zeiten nach Wochentag, Frequenz-Empfehlungen |
| `04-features-aktuell.md` | Vollständige Feature-Übersicht: aktiv, in Test, entfernt |
| `05-best-practices.md` | Strategie, was funktioniert, was nicht mehr funktioniert |
| `06-analytics-metriken.md` | Metriken, Views als Primär-Metrik, Benchmarks, Tools |
| `07-ads-werbung.md` | Werbeformate, Targeting, Preise, AI-Ad-Tools |
