...
**Stand:** September 2026 (Prüflauf 09.09.2026: Motiv-Sperren in CapCut und Dreamina nach dem MPA-Abkommen in `03_KI-Tools-Stack_Bild_Video.md`). Vorher August 2026: offener Punkt Instagram-Rebranding in `08_Asset-Management.md`. Übrige Inhalte Mai 2026
...
## Wichtigste Sätze dieser Guideline
...
| `01_Look-Entwicklung_und_Visual_Identity.md` | Wie man einen konsistenten Look entwickelt |
| `02_Pre-Production_und_Storyboarding.md` | Vor der Produktion: Konzept, Moodboards, Shotlists |
| `03_KI-Tools-Stack_Bild_Video.md` | Konkrete Tool-Empfehlungen Stand Mai 2026 |
| `04_Konsistenz-Techniken.md` | Charakter- und Brand-Konsistenz über Generierungen |
| `05_Hybrid-Produktion.md` | Echte Person + KI-Background, Greenscreen-Workflow |
| `06_Audio_und_Sound-Design.md` | Musik, Sound-Effekte, Voice-Over für Video |
| `07_Post-Production-Workflow.md` | Editing, Color Grading, Export-Specs pro Plattform |
| `08_Asset-Management.md` | Storage, Naming, Versionierung |
| `09_Rechtliches.md` | KI-Recht (EU AI Act), Modell-Rechte, GEMA, BFSG |
| `10_Failure-Modi.md` | Häufige Fehler bei Visual Production |
| `11_Quellen.md` | Recherche-Basis |
...
### 2. KI ist Werkzeug, nicht Lösung

KI-Tools beschleunigen Produktion drastisch. Sie ersetzen aber nicht:
- Strategische Entscheidungen über Look und Voice
- Echte menschliche Authentizität (besonders bei Personen-Content)
- Branchen-spezifisches Insider-Wissen
- Ethische / rechtliche Bewertung

**Faustregel:** Wenn der finale Output zu 100 % KI-generiert ist und dies sichtbar wird, verliert er an Glaubwürdigkeit. Hybrid-Produktion (Säule 05) ist meistens die richtige Strategie.
...
Wer das ignoriert, riskiert Bußgelder bis 35 Millionen Euro (AI Act) oder 100.000 Euro (BFSG). Säule 09 (Rechtliches) ist nicht optional.

### 6. Asset-Chaos früh vermeiden
...
- **Tool-Comparisons aktueller Quellen** (Stand Mai 2026)
- **Praxis-Reviews** aus Creator-Communities
- **Akademische Forschung** zu Charakter-Consistency und Compositing
- **Rechtliche Quellen** für DE/EU-Kontext (EU AI Act, BFSG, GEMA)

Alle Quellen in `11_Quellen.md`.
