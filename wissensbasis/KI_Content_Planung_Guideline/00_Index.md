...
- Caption-Drafts in mehreren Varianten
- Hashtag-Kuration
- Editorial-Calendar-Strukturen
- Multi-Plattform-Repurposing
- Quality-Assurance gegen Brand-Brief
- Performance-Analyse und Mustererkennung

### Nicht gut für
- Authentische, persönliche Stimmen
- Kulturelles Feingefühl in heiklen Momenten
- Krisenkommunikation
- Echte Beziehungspflege in Communities
- Branchen-Insider-Wissen aus erster Hand
...
## Wer diese Guideline nutzen sollte

| Rolle | Nutzen |
|---|---|
| **Brand Manager:in** | Strukturierter Ansatz, KI ins eigene Team zu integrieren |
| **Content Strategist** | Wiederverwendbare Workflows und Prompt-Bibliothek |
| **Social Media Manager:in** | Konkrete Templates für tägliche/wöchentliche Routinen |
| **Agentur-Team** | Methodik, die sich über mehrere Kund:innen skalieren lässt |
| **Solo-Creator** | Schlanker Stack, der ohne großes Team funktioniert |
...
- **Wenn dein KI-Output schwach wird:** lies 07 (Failure-Modi)
- **Wenn dein System nach 4 Wochen läuft:** geh zu 06 (Feedback-Loop)
...
- Best-Practice-Quellen großer Methodiker:innen (Justin Welsh, Dickie Bush, Nicolas Cole)
- Tool-Empfehlungen von Zapier, Buffer, Piktochart, HubSpot
- Workflow-Anleitungen von AdVenture Media, StoryChief, Optimizely
- Eigene Erfahrungswerte aus der Anwendung

Alle Quellen sind in `08_Quellen.md` mit Links dokumentiert.
