...
## Das Wichtigste vorab: AI Slop vermeiden

LinkedIn erkennt generische KI-Inhalte mit einer **Trefferquote von 94%** und reduziert aktiv deren Reichweite. Folgende Muster werden als typisch maschinell erkannt und bestraft:

**Zu vermeiden:**
- "In einer Welt, in der..."
- "Ich bin überwältigt/stolz/dankbar zu teilen..."
- "Lass mich das erklären:" gefolgt von Aufzählung
- Listenformat mit Emoji-Bulletpoints für alles
- Generische "Lektionen" ohne konkrete Situation dahinter
- Vage Formulierungen wie "das ist wichtig für Ihren Erfolg"
- Übermäßig glatte Satzstruktur ohne Stimme

**Goldene Regel:** Klingt es wie ein allgemeiner Ratgeber ohne Absender? Dann klingt es nach KI. Es braucht eine erkennbare Perspektive, konkrete Zahlen, echte Situationen.
...
- "3 Jahre [Tätigkeit] haben mir eines gezeigt:"
...
- "Heute möchte ich über [Thema] sprechen."
- Direkte Einleitung mit dem Thema ohne Spannungsbogen
...
### Kommentare beantworten = +30% Engagement

Buffer-Daten zeigen: Wer konsequent auf alle Kommentare antwortet, steigert sein Engagement um durchschnittlich 30%. Das ist einer der stärksten und einfachsten Hebel auf LinkedIn.

**Qualität der Antworten:**
- Neue Information oder Perspektive hinzufügen
- Echte Folgefragen stellen
- Erfahrung aus eigener Praxis teilen
- Keine One-Liner ("Super, danke!")

### Fremde Posts kommentieren: Tägliche Routine
...
- Eine spezifische Folgefrage stellen
- Respektvolle Gegenmeinung mit Begründung
- Niemals: "Toller Post!" oder "Super Insights!"
...
### Zielgerichtete Verbindungen

- Mit Personen verbinden, die echte Zielgruppe oder potenzielle Kooperationspartner sind
- Verbindungsanfrage immer mit einer personalisierten Nachricht
- Verbindungseinladungen können seit August 2025 nach "Gemeinsame Verbindungen" und "Schule" gefiltert werden
- Qualität über Quantität: Lieber 500 relevante Verbindungen als 5.000 zufällige
...
LinkedIn bevorzugt algorithmisch **Menschen über Marken**. Unternehmensseiten erhalten grundsätzlich weniger organische Reichweite als persönliche Profile.

**Empfohlene Strategie:**
- Mitarbeitende und Führungskräfte als primäre Content-Creator einsetzen
- Unternehmensseite als Hub für Ads, Events und offizielle Infos nutzen
- Thought Leader Ads nutzen, um organischen persönlichen Content zu verstärken
- CEO/Gründer-Profil als stärkster organischer Kanal etablieren

---

## Content-Typen nach Ziel

| Ziel | Content-Typ |
|---|---|
| Reichweite aufbauen | Hot Takes, persönliche Geschichten, kontroverse Meinungen |
| Expertise zeigen | Carousel/Dokument-Posts, Artikel, Fallstudien |
| Engagement erzeugen | Polls, Fragen, "Was meint ihr..."-Posts |
| Leads generieren | Lehrreiche Posts mit DM-CTA, Newsletter-Hinweis |
| Follower gewinnen | Konsequente Positionierung auf ein Thema |
| Conversion | Thought Leader Ads auf organisch gut performende Posts |

---

## Content-Wiederverwendung & Repurposing
...
- **Blog-Post** → Schlüsselpunkte als Carousel, Meinung dazu als Text-Post
...
- Klarer Fokus: Ein Thema, ein Nutzenversprechen
