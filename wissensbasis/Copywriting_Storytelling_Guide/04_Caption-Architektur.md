...
## Die Drei-Akt-Struktur einer Caption

Jede gute Caption hat **drei Akte**:
...
Erste Zeile macht keine Erwartung auf den Rest.
...
## Akt II: Substanz aufbauen

Hier passiert der wahre Inhalt. Vier Hauptstrukturen funktionieren:

### Struktur 1: Listicle (Punkt für Punkt)

**Wann nutzen:** Für How-Tos, Tipps, schnelle Lehren.
...
**Hinweis:** Auf Plattformen ohne Zeilenumbrüche (X/Twitter) muss man kreativer formatieren. Auf IG/LinkedIn: jede Punkt-Nummer eine eigene Zeile.

### Struktur 2: Narrative (Story mit Spannung)

**Wann nutzen:** Für persönliche Anekdoten, Case Studies, Behind-the-Scenes.
...
**Wann nutzen:** Für Werbung, Lead-Generation, Conversion-Content.
...
[Lösung: das verändert es]
[CTA]
```

Sehr wirksam, aber Vorsicht: kann manipulativ wirken, wenn überstrapaziert.

### Struktur 4: Statement + Beweis

**Wann nutzen:** Für faktische Behauptungen, Statistiken, Thought-Leadership.
...
[Implikation: was bedeutet das für die Leser:in?]

[CTA]
```

Funktioniert besonders gut bei B2B / LinkedIn.

---

## Akt III: Call to Action

Hier scheitern die meisten Captions. Typische Fehler:

- **Kein CTA** → keine Handlung
- **Generischer CTA** → „Was denkt ihr?" am Ende jedes Posts → Bedeutungsverlust
- **Zu viele CTAs** → drei Aufforderungen verwirren

**Siehe `05_CTA-Patterns.md`** für vollständige CTA-Methodik.
...
- Listen-Marker: 🟢 / 🔴 / 💡 / 🛑 vor Punkten
- Aufmerksamkeits-Stop: 👇 vor einer wichtigen Zeile (sparsam!)
- Tonalitäts-Färbung: 😅 / 🥲 / 🫠 für selbstironische Marken

**Faustregel:** Wenn ihr Emojis nicht in der gesprochenen Sprache der Voice nutzen würdet, nutzt sie auch nicht in der Caption.
...
2. Bullets (für gleichwertige Punkte)
3. Emojis (für visuelle Listen)

Keine Marker bei narrativem Fließtext.

---

## Hashtag-Strategie

Drastisch verändert über die letzten Jahre.
...
### Was funktioniert in der ersten Zeile

**1. Eine knappe Behauptung mit Information Gap**
- „Diese eine Frage hat unseren Sales-Cycle halbiert."
- → Information Gap: Welche Frage? Klick.

**2. Eine direkte Ansprache**
- „Wenn du heute über 30 bist, lies das."
- → Direkter Adress-Trigger.

**3. Eine konkrete Zahl**
- „47 Sekunden. So lang dauert ein Cold-Call durchschnittlich."
...
## Caption-Architektur-Checkliste
...
- [ ] Kein verbrannter Begriff drin
- [ ] Würde ich das einer Freund:in schicken?

---

## Anti-Patterns

Häufige Schwächen in Captions:

| Anti-Pattern | Beispiel | Korrektur |
|---|---|---|
| **„Wir-Sprache" am Anfang** | „Wir haben heute..." | „Heute hat sich gezeigt: ..." |
| **Aufwärm-Sätze** | „Ein Thema, das uns alle beschäftigt..." | Direkt zum Punkt |
| **Generic Closers** | „Was denkt ihr?" | Spezifische Frage, die zur Caption passt |
| **Hashtag-Salat** | 30 Hashtags am Ende | Max 3, strategisch |
| **Emoji-Inflation** | 🚀💯🔥💪 in jeder Zeile | Strategisch, sparsam |
| **Floskeln** | „Game-Changer", „Disruption" | Konkretes Verb |
| **Caps-Schreierei** | „DAS MUSS JEDER WISSEN!" | Bold/Italic in Maßen |
