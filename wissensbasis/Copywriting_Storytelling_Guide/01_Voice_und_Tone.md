...
|---|---|
| direkt, klar, leicht selbstironisch | im Krisenfall: ernster, ohne Ironie |
| persönlich-warm | im Verkaufsdruck: konkreter, dringlicher |
| kompromisslos präzise | bei Community-Antworten: persönlicher |

Die Voice schreibst du **einmal** auf. Den Tone passt du **pro Kommunikationssituation** an.
...
| Situation | Tone-Anpassung |
|---|---|
| **Standard-Post** | Voice 1:1, keine Modulation |
| **Krise / Krisenkommunikation** | Ernster, ohne Ironie, kürzer, klarer |
| **Erfolg / Meilenstein** | Wärmer, dankender, weniger werblich |
| **Konkurrenz-Vergleich** | Direkter, konkreter, ohne Schmähung |
| **Community-Antwort** | Persönlicher, kürzer, mit Namen |
| **Recruiting / HR-Content** | Vorsichtiger mit Insider-Ironie (Außenwirkung beachten) |
| **Saisonale Themen** | Tonal angepasst (Weihnachten ≠ Karneval ≠ Trauerfall in der Branche) |

Eine **Tone-Matrix** als Tabelle im Brand-Brief macht das systematisch.
...
## Prompt-Vorlage für KI-Voice-Definition

Wenn ihr eure Voice noch nicht klar definiert habt:

```
Ich brauche Hilfe, die Markenstimme für [BRAND] zu definieren.

Hier sind 5-10 echte, gute Posts aus unserer bestehenden Kommunikation:
[POSTS EINFÜGEN]

Analysiere diese Posts und destilliere:
1. Welche Persona schreibt diese Posts? (Alter, Beruf, Haltung)
2. Wo auf den fünf tonalen Achsen liegen wir
   (formal/informell, respektvoll/frech, ernst/ironisch,
    traditionell/modern, expert:innen-hoch/kollegial-augenhöhe)?
3. Welche 3 Adjektive beschreiben die Voice einzigartig
   (nicht generisch)?
4. Welche Sprachregeln sind erkennbar
   (typische Satzlängen, Emoji-Nutzung, Wortwahl-Muster)?
5. Was vermeiden wir konsequent?

Output als strukturierte Voice-Definition für den Brand-Brief.
```

---

## Häufige Fehler bei Voice-Definition
...
| **Voice-Beispiele veralten** | 3 Jahre alte Posts als Referenz | Quartalsweise neue Beispiele nachpflegen |
...
- **Wendy's** (USA) auf Twitter/X: spitzfindig, frech, sticht im Fast-Food-Markt heraus
- **Mailchimp**: kollegial, leicht selbstironisch, lehrend ohne belehrend
