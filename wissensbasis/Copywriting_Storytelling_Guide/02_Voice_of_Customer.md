...
Voice of Customer (VoC) ist die Methodik, **die echte Sprache deiner Zielgruppe systematisch zu sammeln** und in deinen Texten zu verwenden. Es ist der Unterschied zwischen „wir sind führend in Innovation" und „endlich nicht mehr jeden Sonntagabend in Excel-Hölle versinken".

---

## Was Voice of Customer ist

VoC ist kein Marketing-Buzzword. Es ist eine **konkrete Recherche-Methode**, die aus der Conversion-Copywriting-Schule (Wiebe/Copyhackers) kommt. Das Prinzip:

> Statt sich auszudenken, wie deine Zielgruppe über dein Produkt denken sollte, **dokumentierst du, wie sie es bereits tut.**

Dann verwendest du in deinen Texten **ihre eigene Sprache**.

Effekt: Texte fühlen sich für die Zielgruppe nicht wie Werbung, sondern wie Selbst-Beschreibung. Das ist der höchste Conversion-Hebel überhaupt.
...
- **5-Sterne-Reviews mit ausführlichem Text** (was funktioniert, in welcher Sprache?)
- **1-Stern-Reviews** (welche Probleme adressieren wir nicht gut genug?)
...
### 4. Support-Tickets und Customer-Service-Gespräche
...
- „Was hat dich heute auf die Seite/zum Kauf geführt?"
...
### Kategorie A: Pains (Schmerzpunkte)
Was nervt die Zielgruppe konkret? In welchen Worten beschreibt sie es?

*Schwach (von uns erfunden):* „Probleme mit der Zeitplanung"
*Stark (aus echter Review):* „Jeden Sonntagabend wieder Excel-Hölle, und Montag früh ist trotzdem nichts klar"

### Kategorie B: Desires (Wünsche)
Was wäre, wenn das Problem gelöst wäre? In welcher Sprache stellt sich die Zielgruppe das vor?

*Stark:* „Einfach abends ins Bett gehen und wissen, dass morgen alles steht"

### Kategorie C: Objections (Einwände)
Was hält die Zielgruppe vom Kauf/Engagement ab?

*Stark:* „Klingt gut, aber meine Kollegen werden das nie einrichten."

### Kategorie D: Sprache-Muster
Wiederkehrende Begriffe, Vergleiche, Metaphern. **Genau diese Worte** kommen in eure Texte zurück.
...
```markdown
# VoC-Swipe-File [PROJEKT/BRAND]

## Pains
- "Jeden Sonntagabend Excel-Hölle"
  → Quelle: Trustpilot, [Datum]
  → Tag: #zeitdruck #wochenplanung
- "Ich verstehe nicht, warum keiner meine Termine respektiert"
  → Quelle: Reddit, r/[subreddit], [Datum]
  → Tag: #respekt #boundaries

## Desires
- "Einfach abends abschalten können"
  → Quelle: Interview Kund:in B, [Datum]
  → Tag: #ruhe #grenzen

## Objections
- "Klingt gut, aber meine Kolleg:innen werden das nie einrichten"
  → Quelle: Survey Q3, [Datum]
  → Tag: #adoption #team
...
## Prompt-Vorlage für VoC-Analyse

Wenn ihr eine größere VoC-Sammlung habt (z.B. 50+ Reviews), kann KI helfen, Muster zu finden:

```
Hier sind [N] Kunden-Reviews / Forum-Posts / Support-Tickets zu [PRODUKT/THEMA]:
...
5. Welche Worte werden konsequent VERMIEDEN von Kund:innen
   (z.B. Marketing-Jargon, den sie nicht selbst nutzen)?

Wichtig: Behalte die ORIGINAL-FORMULIERUNGEN bei.
Übersetze nicht in "Marketing-Sprech".

Output als strukturierte Swipe-File.
```
...
*Schwach (erfunden):* „Schluss mit Stress in der Wochenplanung!"
*Stark (aus VoC):* „Sonntagabend, Excel auf, und schon wieder dasselbe."

Der zweite Satz ist nicht euer Text. Er ist der Text einer Kund:in. Das ist der Punkt.

### Hebel 2: Objections früh adressieren
Wenn ihr in der VoC-Recherche merkt, dass „aber mein Team wird das nie nutzen" eine häufige Einwand-Formulierung ist, beantwortet sie **in der Caption**, nicht erst auf der Landingpage.

### Hebel 3: Wettbewerber-Schwächen als Differenzierung
Wenn Kund:innen in Wettbewerber-Reviews konsistent etwas kritisieren („zu kompliziert", „brauche 3 Stunden für Setup"), wisst ihr genau, wo ihr euch positionieren könnt.

---

## Häufige Fehler bei VoC-Arbeit
...
| **VoC ohne Kategorisierung** | Sammlung wird unbenutzbar | Tags / Kategorien von Anfang an |

---

## VoC als Differenzierungs-Hebel

Die meisten Marken schreiben Marketing-Sprache, **die ihre Marketing-Abteilung versteht**.

Marken mit guter VoC-Praxis schreiben Marketing-Sprache, **die ihre Kund:innen verwenden**.
