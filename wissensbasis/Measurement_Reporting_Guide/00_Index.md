...
**Stand:** September 2026 (Prüflauf 09.09.2026: drei parallele View-Begriffe bei YouTube in `02_Metriken-Definitionen.md`, EU-Nutzerzahlen aus den DSA-Meldungen in `04_Benchmarks.md`). Vorher August 2026: YouTube-View-Bruch in `02_Metriken-Definitionen.md`, Buffer- und Emplifi-Daten in `04_Benchmarks.md`, Google Search Console Platform Properties in `05_Attribution_und_ROI.md`. Übrige Inhalte Juni 2026
