...
## Verfügbare Metriken (X Analytics)
...
| **Video Views** | Für Video-Posts: Gesamtaufrufe |
| **Watch Time** | Durchschnittliche Sehdauer bei Videos |
...
- Hoher Non-Follower-Anteil = Content verbreitet sich über die eigene Community hinaus

### Active Followers Display (seit Mai 2026)
- Zeigt wie viele der eigenen Follower tatsächlich auf X aktiv sind
- Gibt realistischen Kontext zur tatsächlichen Reichweite (vs. nomineller Follower-Zahl)

---

## Radar Analytics

**X Radar** ist ein erweitertes Analytics-Tool (seit Oktober 2024, zunehmend ausgerollt):
- **Keyword Analytics:** Beliebige Keywords tracken und Mentions über Zeit beobachten
- **Trend-Tracking:** Wie entwickelt sich das Gesprächsvolumen zu einem Thema?
- **Conversation Volume:** Wann wird am meisten über ein bestimmtes Thema gesprochen?
- **Ideal für:** Brands, Journalisten, PR-Teams, Market Intelligence
...
1. **Top-3-Posts:** Welche hatten die meisten Replies/Quotes? Was war das Thema, der Stil, die Länge?
...
- X Analytics → "Activity" Tab zeigt wann Impressionen und Engagements am höchsten sind
- Mindestens 4 Wochen konsistentes Testen: gleiche Content-Typen zu verschiedenen Zeiten
- Für Breaking News: immer sofort, nicht warten auf "beste Zeit"
...
| Tool | Stärken für X |
|---|---|
| X Radar | Keyword-Tracking, Trendvolumen |
| Hootsuite | Umfassende Multi-Post-Analytics |
| Sprout Social | Deep-Dive Engagement-Analyse |
