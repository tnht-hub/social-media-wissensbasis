...
### Articles (Long-Form)
- Direkt auf X publizieren statt Blog-Link → höhere organische Reichweite
- $1M-Preis (seit Januar 2026): Incentiv für Impact-starke, viel diskutierte Artikel
...
### Links im Post: Neue Praxis (seit 2024)
X reduziert die Reichweite von Posts mit externen Links. Best Practice:
1. Post ohne Link veröffentlichen
2. Eigene Antwort mit dem Link direkt darunter setzen
3. Oder: Link in den Article-Text integrieren (natives Format)

### Community Notes vermeiden
- Faktisch falsche oder irreführende Aussagen erhalten Community Notes → stark negatives Vertrauenssignal
- Bei umstrittenen Themen: Quellen direkt im Post angeben

---

## Premium-Strategie

Für Brands und professionelle Creator lohnt sich X Premium wegen:
- **Post-Bearbeitung** (bis 30 Min.): Tippfehler und Links korrigieren
- **Articles:** Thought Leadership Content nativ auf X
- **Custom Timelines:** Relevante Branchenthemen im eigenen Feed bündeln
- **Längere Videos:** Bis 3 Stunden für Webinare, Events, Interviews
- **Revenue Share:** Engagement von anderen Premium-Nutzern löst Monetarisierung aus
- **Algorithmisches Boost:** Premium-Engagement wird vom Algorithmus stärker gewichtet
...
- **Massen-Reposting** fremder Inhalte → algorithmisch abgestraft (Mai 2026)
- **Externe Links direkt im Post** → Reichweiten-Reduktion
- **X Communities** → eingestellt Mai 30, 2026
- **Hohe Posting-Frequenz ohne Qualität** → führt bei Nicht-Premium zu Posting-Limits (Mai 2026)
...
|---|---|
| Echtzeit-Diskurse | Tiefe, formatierte Beiträge |
| Tech/Finance/Startup-Community | Breite Berufsgruppen |
| Viral durch Nischen-Influencer | Stabile organische Reichweite |
| Persönlichkeit und Meinung | Professionelles Netzwerk |
| Breaking News | Evergreen Content |

**Fazit:** X ist besonders stark für Brands in Tech, Finance, Medien, Politik und Startups. Für klassische B2B-Unternehmen außerhalb dieser Branchen ist LinkedIn in der Regel effektiver.

---

## Brand Safety: Was Brands wissen müssen

- Harvard-Studie (April 2026): Dokumentierter Anstieg polarisierender Inhalte auf X seit 2022
