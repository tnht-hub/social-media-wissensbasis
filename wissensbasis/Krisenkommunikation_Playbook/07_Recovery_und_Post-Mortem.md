...
Nach der akuten Krise laufen zwei Stränge parallel:
...
- **Abschluss-Statement:** Ein finales Update, das die akute Phase formal schließt
...
## Track B: Internal Post-Mortem

### Was Post-Mortem ist (und was nicht)

**Post-Mortem ist:**
- Systematische Analyse, was passiert ist
- Identifikation von Strukturen, die zur Krise geführt haben
- Konkrete Ableitungen für Prävention
- Lernens-Dokumentation für das gesamte Team

**Post-Mortem ist NICHT:**
- Schuldzuweisungs-Runde
- Tribunal für Mitarbeiter:innen
- Vergangenheits-Aufarbeitung ohne Zukunfts-Wirkung
- Politik (es geht nicht darum, wer „recht hatte")

### Post-Mortem-Methodik
...
```
1. Faktenchronologie (45 Min)
   - Was ist wann passiert?
   - Wer hat was wann gewusst?
   - Welche Entscheidungen wurden wann getroffen?

2. Ursachen-Analyse (60 Min)
   - 5-Why-Methode oder Fishbone-Diagramm
   - Strukturelle vs. individuelle Faktoren trennen
   - Lückenanalyse (was ist nicht passiert, was hätte passieren müssen?)

3. Was hat gut funktioniert? (30 Min)
   - Welche Reaktionen waren richtig?
   - Welche Strukturen haben gehalten?
   - Was sollte beibehalten werden?

4. Was sollte geändert werden? (60 Min)
   - Strukturelle Änderungen (Prozesse, Verantwortlichkeiten)
   - Tooling-Änderungen
   - Trainings-Bedarf
   - Krisenstab-Anpassungen

5. Konkrete Action-Items mit Owner und Deadline (30 Min)
   - Jede Erkenntnis bekommt eine:n Verantwortliche:n
   - Jedes Action-Item bekommt eine Deadline
   - Follow-up in 30 / 60 / 90 Tagen
```

### Post-Mortem-Teilnehmer:innen
...
[Was im System hat zur Krise geführt?]

### Verfahrens-Faktoren
[Welche Prozesse waren unzureichend?]

### Individuelle Faktoren
[Wo waren menschliche Fehler relevant? Blameless formuliert.]

## Was hat gut funktioniert
[Konkrete Beispiele guter Reaktion]

## Was sollte geändert werden
[Konkrete Änderungs-Vorschläge]
...
## Lessons für das Krisen-Playbook
[Welche Änderungen am Playbook leiten wir ab?]
```

### Häufige Post-Mortem-Fehler

| Fehler | Konsequenz |
|---|---|
| **Schuldzuweisungs-Kultur** | Mitarbeiter:innen verschweigen Fehler in der Zukunft |
| **Action-Items ohne Owner** | Nichts wird umgesetzt |
| **Kein Follow-up** | Erkenntnisse verlieren sich, Krise wiederholt sich |
| **Politik** | Wer „recht hatte" wird wichtiger als Strukturverbesserung |
| **Zu schnell durch** | Oberflächliche Analyse, echte Ursachen werden nicht gefunden |

---

## Krisen-Playbook aktualisieren

Jede Krise ist eine Lernchance für das Playbook. Konkret:

| Bereich | Frage |
|---|---|
| **Eskalations-Bewertung (Säule 01)** | War unsere Krisen-Typologie ausreichend? Gibt es neue Krisen-Typen? |
| **Stakeholder-Mapping (Säule 02)** | Haben wir alle Stakeholder erreicht? Wer war übersehen? |
| **Timeline (Säule 03)** | Waren unsere Zeitvorgaben realistisch? Was war zu langsam? |
| **Tonalität (Säule 04)** | Hat unsere Voice in der Krise getragen? Was war falsch? |
| **Apologia (Säule 05)** | War unsere Strategie-Wahl richtig? |
| **Plattform-Reaktion (Säule 06)** | Welche Plattformen waren überraschend wichtig / unwichtig? |
| **Krisenstab-Setup (Säule 08)** | Waren die richtigen Leute drin? Hat das Setup funktioniert? |

Action-Items aus dem Post-Mortem fließen direkt in das Playbook-Update.
...
|---|---|
| **Sentiment-Verlauf (Social Listening)** | Wie verändert sich die öffentliche Stimmung über Zeit? |
| **Brand Search Volume** | Wie oft wird nach der Marke gesucht (Google Trends)? |
| **Direct Traffic auf Website** | Kommen Menschen direkt zur Marke? |
| **NPS / Kundenzufriedenheit** | Wie zufrieden sind Bestandskund:innen? |
| **Churn-Rate** | Wie viele Kund:innen verlassen die Marke? |
...
**Konsequenz:** Manche Krisen sind so schwer, dass die Marke nie wieder zu vorherigem Vertrauen kommt. In solchen Fällen ist Re-Branding eine Option, die diskutiert werden sollte (auch wenn sie als „Flucht" wahrgenommen wird).
