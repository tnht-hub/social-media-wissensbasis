...
Diese Säule dokumentiert die Phasen einer Krisenreaktion.

---

## Warum Timeline 2026 anders als 2023 ist

Aktuelle Krisenkommunikations-Studien zeigen: **Krisen entwickeln sich 2026 doppelt so schnell wie 2023.**
...
- [ ] Vorfall dokumentiert (was, wann, wo, wer)
- [ ] Eskalations-Bewertung nach Säule 01 durchgeführt
- [ ] Krisenstab aktiviert (alle vordefinierten Mitglieder informiert)
- [ ] CEO informiert
- [ ] Rechtsteam informiert
- [ ] Monitoring-Tools intensiviert (Reichweite, Sentiment, neue Mentions)
- [ ] Erste Faktenlage zusammengetragen
...
- Signalisiert: Wir wissen davon, wir schlafen nicht
- Signalisiert: Wir nehmen es ernst
- Vermeidet das Vakuum, das sonst von anderen gefüllt wird
- Gewinnt Zeit für die vollständige Antwort

### Aufbau eines Holding Statements

**Komponente 1: Anerkennung**
> „Wir sind über die Berichte zu [Vorfall] informiert."

**Komponente 2: Empathie (wenn Menschen betroffen sind)**
> „Unsere Gedanken sind bei den Betroffenen."

**Komponente 3: Action-Versprechen**
> „Wir untersuchen den Sachverhalt mit höchster Priorität."

**Komponente 4: Folge-Versprechen**
> „Wir melden uns mit ausführlichen Informationen, sobald verlässliche Angaben möglich sind."

**Komponente 5 (optional): Kontakt**
> „Für direkte Anfragen erreicht ihr uns unter [Kontakt]."

### Beispiel-Holding-Statement (Cluster B, Service-Panne)

> Wir sind über die heute Morgen aufgetretenen Service-Probleme informiert. Unsere Gedanken sind bei allen Kund:innen, die davon betroffen sind. Unser Team arbeitet aktuell mit höchster Priorität an einer Klärung. Wir melden uns mit detaillierten Informationen, sobald verlässliche Angaben möglich sind. Für dringende Anfragen erreicht ihr unseren Support unter [Kontakt].

### Was ein Holding Statement NICHT enthält

- Schuld-Zuweisungen (weder an sich noch an Dritte)
- Spekulationen über Ursachen
- Konkrete Zahlen, die nicht verifiziert sind
- Versprechen, die nicht haltbar sind (z.B. „Das wird nie wieder passieren")
- Defensive Sprache („Bedauerlicherweise...", „Falls jemand betroffen sein sollte...")

### Wo das Holding Statement ausgeht
...
**2. Verantwortungs-Einordnung**
- Wer ist verantwortlich? (Wir selbst, externe Faktoren, Mischung?)
- Wie ist es passiert? (Nicht: Schuldzuweisung, sondern Erklärung)

**3. Empathie / Anerkennung**
- Anerkennung des Schadens für Betroffene
- Bei Cluster C: explizite Entschuldigung

**4. Korrekturmaßnahmen**
- Was tut ihr JETZT, um die Folgen zu lindern?
- Was tut ihr ZUKÜNFTIG, um Wiederholung zu vermeiden?
- Welche konkreten Schritte mit welchem Zeitrahmen?

**5. Kontakt / Hilfe**
- Wie kommen Betroffene zu euch?
- Wer ist Ansprechpartner:in?
- Welche Unterstützung gibt es?

### Tonalität (siehe `04_Tonalitaet_und_Sprache.md`)

In dieser Phase gilt:
- Klar, sachlich, ohne PR-Floskeln
- Menschliche Sprache, kein Anwalts-Deutsch
- Keine Hochsprache, keine technischen Begriffe ohne Erklärung
- Empathisch ohne theatralisch
...
Auch wenn nichts Neues passiert ist: **Schweigen wird als Desinteresse gelesen**. Tägliche kurze Updates halten Vertrauen warm:

> „Update Tag 3: Wir konnten heute 80 % der betroffenen Datensätze verifizieren und Betroffene direkt informieren. Die restlichen 20 % adressieren wir morgen."
...
Was wird in der Presse geschrieben? Welche Sentiment-Entwicklung? Gibt es zweite Wellen (z.B. Whistleblower, die zusätzliche Details liefern)?

### Korrekturmaßnahmen sichtbar machen

Was ihr **sagt**, dass ihr tut, müsst ihr **zeigen**, dass ihr tut. Beispiele:
- Personelle Konsequenzen
- Externe Audits beauftragen
- Compliance-Strukturen anpassen
- Entschädigungen ausrollen
...
### Achtung: Nicht zu früh entspannen

Zwei Risiken in dieser Phase:

**1. Zweite Welle.** Manche Krisen kommen in einer zweiten Welle wieder, wenn z.B. neue Details auftauchen, betroffene Personen ihre Geschichte erzählen oder Medien ein Recap machen.

**2. Vorzeitige Entspannung.** Wer in Tag 8 wieder „business as usual" kommuniziert, signalisiert, dass die Krise nicht wirklich wichtig war. Reputation braucht länger als Aufmerksamkeit.
...
Siehe `07_Recovery_und_Post-Mortem.md` für die Methodik.

---

## Realitäts-Check: Wenn der ideale Zeitplan nicht haltbar ist
...
- Post-Mortem-Meeting: __:__
- Lessons-Learned-Dokumentation bis: __:__
```
