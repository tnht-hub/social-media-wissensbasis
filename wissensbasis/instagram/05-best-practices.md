...
## Die wichtigsten Grundregeln (offiziell bestätigt)

Diese Punkte stammen direkt aus offiziellen Instagram-Quellen / Adam Mosseri-Aussagen:

1. **Kein TikTok-Wasserzeichen** → Stark negative Auswirkung auf Reichweite
2. **Kein Engagement Bait** → Direkt bestraft
3. **Reels unter 90 Sekunden** → Höhere Distribution
4. **Originaler Content** → Reposter werden aus Empfehlungen ausgeschlossen
5. **Audio immer einbinden** → Pflicht für Empfehlungen, auch bei Bild-Reels
6. **"Link in Bio" ist okay** → Mosseri bestätigt: kein negativer Reichweiten-Effekt (Juli 2025)
7. **Eigenes Logo als Wasserzeichen ist okay** → Kein negativer Effekt (Mosseri, Oktober 2024)
...
Instagram belohnt Videos, die Nutzer nicht wegscrollen. Alles, was das Scroll-Verhalten in den ersten 3 Sekunden stoppt, erhöht Watch Time und damit Reichweite.

> **Beleg aus der Praxis:** In einer dokumentierten Beobachtung trug ein Reel mit Frage-Einstieg, durchgehender Untertitelung und klarer Bildsprache rund das 30-Fache des Kanal-Medians. Die handwerklichen Mindeststandards waren Voraussetzung der Ausspielung, nicht Zugabe. Externe Beobachtung, kleiner Datensatz, am eigenen Median zu prüfen. Stand Juni 2026.

**Starke Video-Hooks:**
- Überraschende Aussage oder provokante These sofort
- Visually striking: auffälliges Bild, Bewegung, Kontrast
- Frage, die neugierig macht: "Warum machen alle [X] falsch?"
- Ergebnis zuerst zeigen, dann erklären wie
- Text-Overlay mit Kernaussage ab Sekunde 1
...
### Edits-App nutzen
Adam Mosseri bestätigt einen kleinen, aber messbaren Reach-Boost für Reels, die mit der **Edits-App** erstellt wurden. Bei gleichwertigem Content immer Edits bevorzugen.

### Trial Reels strategisch einsetzen
- Neuen, experimentellen Content zuerst als Trial Reel testen
- Wenn die Nicht-Follower-Performance gut ist → regulär veröffentlichen
- Ideal für Themen, bei denen unsicher ist, ob die eigene Community sie will

---

## Carousels: Best Practices

### Warum Carousels funktionieren
- Jede Slide ist eine neue Interaktionsmöglichkeit
- Wer aufhört zu scrollen, sieht den Post später erneut
...
- Mini-Infografiken
- "Lessons learned" aus echten Erfahrungen

---

## Hashtags: Die neue Wahrheit

**Adam Mosseri Februar 2025:** *"Hashtags funktionieren nicht."*

### Aktueller Stand
- Hashtag-Limit: 3 pro Post (seit November 2025, von 30 reduziert)
- Hashtags folgen: Nicht mehr möglich (seit November 2024)
- Hashtags helfen nicht bei der Discovery für neue Nutzer
- Hashtags dienen allenfalls noch der Kategorisierung / SEO-Zwecken

### Empfehlung
- Maximal 3 extrem relevante Hashtags verwenden oder komplett weglassen
- Energie besser in starken Content stecken als in Hashtag-Recherche
- Hashtag-Spamming schadet mehr als es nützt
...
Die ersten Reaktionen nach dem Veröffentlichen sind entscheidend für die algorithmische Weiterverteilung:
- Selbst kommentieren (z.B. Link zu verwandtem Content, Frage ans Publikum)
- Erste Kommentare sofort beantworten
- In der App bleiben und aktiv sein

### Content, der gesharet wird (Sends maximieren)
...
- **Keywords für Google:** Da Posts nun in Google Search erscheinen, relevante Begriffe natürlich einbauen
...
- Monthly Performance Summary auswerten

### 10.000+ Follower (Skalierung)
- Systematisches Content-Testing via Trial Reels
- Competitive Insights (Meta Verified) für Benchmarking
- Creator Marketplace für Marken-Kooperationen
- Locked Posts für Community-Aktivierung
