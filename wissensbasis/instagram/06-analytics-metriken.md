...
## Alle verfügbaren Metriken (IST-Zustand)

### Reels-Metriken

| Metrik | Verfügbar seit | Bedeutung |
|---|---|---|
| Views | Standard | Gesamtzahl der Aufrufe |
| View Rate | Januar 2025 (→ ersetzt durch Skip Rate) | % der Follower/Nicht-Follower, die >3s geschaut haben |
| **Skip Rate** | **August 2025** | Ersatz für View Rate; % die weggescrollt haben |
| **Retention** | **August 2025** | Verbleibende Zuschauer über die Video-Länge |
| Watch Time | Standard | Durchschnittliche Sehdauer |
| Completion Rate | Standard | % die das Video zu Ende geschaut haben |
| Likes | Standard | Positives Engagement |
...
| Metrik | Details |
|---|---|
| Profile Views | Besuche auf dem Profil |
| Reach (Gesamt) | Summe aller einzigartigen Nutzer |
| Follower-Wachstum | Trend über Zeit |
...
- **Monthly Performance Summary** (April 2025): Inkl. beste Posting-Zeiten, Follower-Aktivität
- **Shareable Insights als PDF** (Oktober 2025): Via Edits-App exportierbar
- **Stats per Post im Edits Ideas-Tab** (November 2025)

---

## Engagement-Rate: Was ist gut?

Branchen-Benchmark für Instagram 2026 (über alle Formate):
...
## Skip Rate vs. View Rate

Seit August 2025 hat Instagram die **View Rate** durch die **Skip Rate** ersetzt.
...
## Analytics für gezielte Optimierung

### Wöchentliche Review-Routine

1. **Top-Performer:** Welche 3 Posts hatten die höchste Reichweite/Engagement? Was haben sie gemeinsam? (Hook, Format, Thema, Zeit)
2. **Skip Rate analysieren:** Welche Reels haben hohe Skip Rate? Hook verbessern.
3. **Sends beobachten:** Welcher Content wird geteilt? Mehr davon.
4. **Follower-Wachstum:** Welche Posts haben Follower gebracht?
5. **Stories:** Wo steigen Nutzer aus? Contentlänge oder Qualität anpassen.
